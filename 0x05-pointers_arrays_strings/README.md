...
-   [Arrays & Pointers in C Programming Explained](https://intranet.alxswe.com/rltoken/fAbvIu4ESCb1JcE3EU1Kmw "Arrays & Pointers in C Programming Explained")

Learning Objectives
-------------------

At the end of this project, you are expected to be able to [explain to anyone](https://intranet.alxswe.com/rltoken/OLGzIaD19ia5NZ-WCMckeg "explain to anyone"), **without the help of Google**:
