...
-   **Auto QA review:** 36.0/36 mandatory & 16.0/21 optional
-   **Altogether:**  **176.19%**
    -   Mandatory: 100.0%
    -   Optional: 76.19%
    -   Calculation:  100.0% + (100.0% * 76.19%)  == **176.19%**
...
-   [Do I cast the result of malloc?](https://intranet.alxswe.com/rltoken/PzoxOdLmWQ9TQFZiRXuh_w "Do I cast the result of malloc?")
...
-   [Practical use of MALLOC in C - Dynamic Memory Allocation](https://intranet.alxswe.com/rltoken/KAIl1hV_EYMXsEWKkUudwg "Practical use of MALLOC in C - Dynamic Memory Allocation")
